...
function getContentTab(url,selector){
	...
	var loadding = '<div class="a-center a-center-loading"><img src="//theme.hstatic.net/200000281397/1000675334/14/rolling.svg?v=44"</div>'
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
...
$(document).ready(function(){
	...
	if (img_array.length == 1) {
		...
		$('.img_bg_product .bg1').attr("style" , "background-image:url(//theme.hstatic.net/200000281397/1000675334/14/bg_default_pro_1.jpg?v=44)");
		$('.img_bg_product .bg2').attr("style" , "background-image:url(//theme.hstatic.net/200000281397/1000675334/14/bg_default_pro_2.jpg?v=44)");
	}
