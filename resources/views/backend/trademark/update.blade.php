            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <form id="cerfitication" action="{{ route('trademark.postUpdate', $trademark->id) }}" method="POST"
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mt-1 mb-1">
                                                <label for="inputName" class="form-label mb-1">Link:</label>
                                                <input type="text" id="name" name="name"
                                                    value="{{ $trademark->link }}" class="form-control" placeholder="Nhập link">
                                            </div>
                                            <input type="hidden" name="images" value="{{ $trademark->images }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12  ps-5 mb-2">
                                    <a href="{{ route('admin.Trademark') }}" class="btn btn-secondary">Quay lại</a>
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="card card-app-design">
                    <div class="card-body">
                        ...
                        margin-bottom: 20px;
                    ">
                            <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="img_trademark"
                                src="{{ $trademark->images }}" alt="..">
                        </div>
            ...
            CKFinder.modal({
                ...
                onInit: function(finder) {
                    finder.on('files:choose', function(evt) {
                        ...
                        var img = document.getElementById('img_trademark')
