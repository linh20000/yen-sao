    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <form action="{{route('trademark.create')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="link" name="link" value="{{old('link')}}" class="form-control" placeholder="Nhập link">
                                        @error('link')
            ...
            <div class="card-body">
                <div id="imgList"
                    style="
                        ...
                        margin-bottom: 20px;
                    ">
                    <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="img_trademark" src="{{asset('upload_thumbnail/empty_img.png')}}"  alt="..">
                </div>
