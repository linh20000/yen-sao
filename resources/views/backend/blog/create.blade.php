                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mt-1 mb-1">
                                                <label for="inputName" class="form-label mb-1">Tên người đăng:</label>
                                                <input type="text" id="name" name="name"
                                                    value="{{ old('name') }}" class="form-control" placeholder="Nhập tên người đăng">
                                                @error('name')
                                                    <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group mt-1 mb-1">
                                                <label for="inputName" class="form-label mb-1">Tên bài:</label>
                                                <input type="text" id="subname" name="subname"
                                                    value="{{ old('subname') }}" class="form-control"
                    ...
                    <div class="card-body">
                        ...
                        ">
                            <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="img_blog"
                                src="{{ asset('upload_thumbnail/empty_img.png') }}" alt="..">
                        </div>
